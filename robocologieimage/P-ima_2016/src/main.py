...
from utilities import get_refs, get_classifier
...
## Project files
LIVE = (1,)
FOO1 = [('../data/video/kinect/2016-03-07-160118.webm',
       '../data/video/kinect/2016-03-07-155725.webm',
       '../data/video/kinect/2016-03-07-154756.webm'),
       ([21, 22, 23, 24, 25, 26, 27, 29, 20, 30, 31],
       [21, 22, 23, 24, 25, 26, 27, 29, 20, 30, 31],
       [21, 22, 23, 24, 25, 26, 27, 29, 20, 30, 31]),
       "KINECT_ISIR"]

FOO2 = [('../data/video/kinect/2016-03-17-010620.webm',
         '../data/video/kinect/2016-03-17-011145.webm',
         '../data/video/kinect/2016-03-17-012058.webm'),
        ([20, 30, 31],
        [20, 30, 31],
        [20, 30, 31]),
        "KINECT_HOUSE"]
