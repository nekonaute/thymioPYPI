...
class SimulationFollowLightGenBis(Simulation.Simulation) :
	def __init__(self, controller, mainLogger) :
		...
		self.mainLogger.debug("SimulationFollowLightGenBis - __init__()")
	...
	def preActions(self) :
		...
		self.mainLogger.simu("====== SimulationFollowLightGenBis ======")
		self.mainLogger.simu("======================================")
		self.mainLogger.simu("-------------------")
	...
	def broadcast(self,genome,fitness):
		try :
			...
			self.mainLogger.error('"SimulationFollowLightGenBis - error in broadcast()' )
	...
	def Braitenberg(self, proxSensors) :
		...
		#put rpifiles/experiments/FollowLightGenBis ~/dev/thymioPYPI/OctoPY/rpifiles/experiments
		#put rpifiles/experiments/config_FollowLightGenBis.cfg ~/dev/thymioPYPI/OctoPY/rpifiles/experiments
