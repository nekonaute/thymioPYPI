...
Classe Genome utilisée pour représenter le génome de l'algorithme génétique de poussage d'objet.
"""
...
class Genome:
	...
	def sigmoide(self,x):
		...
		try:
			a = (1/(1+ math.exp(-x))) * Params.params.maxSpeedValue *2  - Params.params.maxSpeedValue
			return a
