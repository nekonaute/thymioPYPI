...
total_evals = 200           # one eval is lifetime/social or reevaluation
max_robot_lifetime = 200    # either 200 or 100
seed = 0                    # experiment seed

# genome memory parameters
disable_sensor = 0.0          # change that sensor is enabled for every sensor
...
max_fitness = 175000.0     # max fitness